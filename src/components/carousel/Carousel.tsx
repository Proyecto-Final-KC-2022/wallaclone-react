...
const style = {
  ...
  swiperSlideWrapper:
    "xl:hover:border md:hover:border rounded-[10px] items-center justify-center text-center text-[#90A4AE] hover:text-[#13c1ac] w-[130px] h-[152px] flex-col py-4 cursor-pointer",
  imgWrapper: "xl:flex md:flex justify-center items-center w-full hidden",
  imgContainer: "w-[68px]",
  swiperText:
    "text-center xl:text-[1rem] md:text-[1rem] text-xs py-[16px] inline-block align-baseline tracking-tighter",
};
