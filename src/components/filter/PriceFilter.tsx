  ...
  return (
    <div className="block fixed top-[130px] left-[234px] mx-[1rem] bg-white rounded-[10px] shadow-md overflow-hidden min-w-[380px]">
        ...
        <div className="block">
          <form className="overflow-hidden block">
            <form className="flex items-center justify-center">
                <Box className="py-[40px] px-[1.5rem] inline-block relative w-full" sx={{ width: 332, color: "success.main" }}>
                  <Slider
            ...
            <div className="mt-[1rem] flex">
                ...
                <div className="mr-[0.5rem] flex flex-col">
      ...
      <div className="h-[88px] px-[1.5rem] items-center justify-end flex">
        ...
        <button className="py-[8px] cursor-pointer text-white px-[20px] rounded-[25px] bg-[#13c1ac] hover:bg-[#0f9989] border border-[#13c1ac]">Aplicar</button>
      </div>
    </div>
  );
};
